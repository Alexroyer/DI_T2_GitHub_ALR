        ...
        if (!errorFormato) {
            try {
                ...
                if ((textFieldNombre.getText() != null) && !textFieldNombre.getText().isEmpty()) {
                    ...
                    errorFormato = true;
                    alerta = new Alert(AlertType.INFORMATION, "Introduce un nombre");
                    alerta.showAndWait();
                }
                ...
                if (textFieldApellidos.getText() != null && !textFieldApellidos.getText().isEmpty()) {
                    ...
                    errorFormato = true;
                    alerta = new Alert(AlertType.INFORMATION, "Introduce los apellidos");
                    alerta.showAndWait();
                }
                ...
                if (textFieldTelefono.getText() != null && !textFieldTelefono.getText().isEmpty()) {
                    ...
                    errorFormato = true;
                    alerta = new Alert(AlertType.INFORMATION, "Introduce un teléfono");
                    alerta.showAndWait();
                }
                ...
                if (textFieldEmail.getText() != null && !textFieldEmail.getText().isEmpty()) {
                    ...
                    errorFormato = true;
                    alerta = new Alert(AlertType.INFORMATION, "Introduce un correo");
                    alerta.showAndWait();
                }
                ...
                if (textFieldEmail.getText() != null && !textFieldNumHijos.getText().isEmpty()) {
                    try {
                        ...
                        errorFormato = true;
                        alerta = new Alert(AlertType.INFORMATION, "Número no válido");
                        alerta.showAndWait();
                ...
                if (textFieldSalario.getText() != null && !textFieldSalario.getText().isEmpty()) {
                    try {
                        ...
                        errorFormato = true;
                        alerta = new Alert(AlertType.INFORMATION, "Salario no válido");
                        alerta.showAndWait();
                ...
                if (comboBoxProvincia.getValue() != null) {
                    ...
                    alerta = new Alert(AlertType.INFORMATION, "Elige una provincia");
                    alerta.showAndWait();
                    errorFormato = true;
                }
